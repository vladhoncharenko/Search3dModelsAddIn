...
namespace Search3dModels
{
    ...
    public class SwAddin : ISwAddin
    {
        ...
        ConnectionSettings connectionSettingsForm;
        AddModelsFromFolder addModelsFromFolderForm;
        ...
        {
            get { return connectionSettingsForm; }
            set { connectionSettingsForm = value; }
        }
        public AddModelsFromFolder AddModelsFromFolder
        {
            get { return addModelsFromFolderForm; }
            set { addModelsFromFolderForm = value; }
        }
        #endregion
        ...
        public void LoadConnectionSettingsForm()
        {
            try
            {
                connectionSettingsForm = new ConnectionSettings(this);
        ...
        public void RemoveConnectionSettingsForm()
        {
            try
            {
                if (connectionSettingsForm != null)
                    connectionSettingsForm.Close();
            }
            catch { connectionSettingsForm = null; }
        }

        public void LoadAddModelsFromFolderForm()
        {
            try
            {
                addModelsFromFolderForm = new AddModelsFromFolder(this);
        ...
        public void RemoveAddModelsFromFolderForm()
        {
            try
            {
                if (addModelsFromFolderForm != null)
                    addModelsFromFolderForm.Close();
            }
            catch { addModelsFromFolderForm = null; }
        }
        #endregion
