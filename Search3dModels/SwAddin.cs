...
namespace Search3dModels
{
    ...
    /// <summary>
    /// Summary description for Search3dModels.
    /// </summary>
    [Guid("002659f1-a495-4210-8e0f-4114f8aa0602"), ComVisible(true)]
    [SwAddin(
        Description = "Search3dModels description",
   ...
   public MainForm MainForm  
       {  
        ...
        public void AddCommandMgr()
        {
           ...
           // cmdIndex2 = cmdGroup.AddCommandItem2("Show PMP", -1, "Display sample property manager", "Show PMP", 2, "ShowPMP", "EnablePMP", mainItemID2, menuToolbarOption);
            cmdIndex1 = cmdGroup.AddCommandItem2("Моя форма", -1, "Моя самая первая форма в аддоне", "Моя форма", 2, "LoadMyForm", "EnableMethod", mainItemID3, menuToolbarOption);
        ...
        public void LoadMyForm()
        {
            ...
            {
                if (m_form == null)
                    m_form = new MainForm(this);//Вот тут то как раз мы и передаем экземпляр аддона в нашу форму  
                m_form.Show();
            }
            catch
            {
